        ...
        child: Scaffold(
            ...
            body: SingleChildScrollView(
              ...
              children: [
                ...
                offers(size),
                menuHeader(size),
                menuBarDishes(size, 1, "Pro Membeership", 0),
                isEnabled[0]
                    ? menuBarDishesItemBuilder(size, 6, 1)
                    : Container(),
                menuBarDishes(size, 12, "Today's Exclusive Dish", 1),
                isEnabled[1]
                    ? menuBarDishesItemBuilder(size, 6, 12)
                    : Container(),
                menuBarDishes(size, 5, "Zomato Special Combo", 2),
                isEnabled[2]
                    ? menuBarDishesItemBuilder(size, 6, 5)
                    : Container(),
                menuBarDishes(size, 4, "Our Speciality", 3),
                isEnabled[3]
                    ? menuBarDishesItemBuilder(size, 6, 4)
                    : Container(),
                ...
                isEnabled[5]
                    ? menuBarDishesItemBuilder(size, 6, 23)
                    : Container(),
              ],
            )),
  ...
  Widget menuHeader(Size size) {
    return Container(
      ...
      child: Row(children: [
        ...
        menuItem(size, "Egg"),
        menuItem(size, "Veg"),
        menuItem(size, "Search"),
      ]),
    );
  }

  Widget menuItem(Size size, String text) {
    return Padding(
      padding: EdgeInsets.all(8),
      child: Container(
